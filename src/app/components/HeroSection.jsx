  ...
  return (
    <BackgroundBeamsWithCollision>
      <section className=" mx-auto bg-transparent  w-[100%]  flex items-center justify-center h-screen">
        <div className=" bg-transparent text-center  w-[65%]">
          <motion.div
          ...
          >
            {/* <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
              <span className="text-white mb-4 text-2xl sm:text-5xl lg:text-5xl lg:leading-normal font-extrabold">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-300 to-gray-500">
                  Hello, I&apos;m Dawit
                </span>
              </span>
              , a Full Stack Developer. I love crafting websites and apps that
              combine seamless functionality with great design, ensuring a
              smooth and engaging user experience.
            </p> */}
            <p className="text-[#ADB7BE] text-sm sm:text-lg mb-6 lg:text-xl">
              <span className="text-white mb-4 text-xl sm:text-4xl lg:text-4xl lg:leading-normal font-extrabold">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-300 to-gray-500">
                  Hello, I&apos;m Dawit
                </span>
              </span>

              <span className="text-white text-xl font-sans sm:text-3xl lg:text-4xl lg:leading-normal">
                <span className="font-thin ">
                  , a Full Stack Developer. I love crafting websites and apps
                  that combine seamless functionality with great design,
                  ensuring a
                </span>
                <span className="font-thin"> smooth and</span>
                <span className="font-thin"> engaging user experience</span>.
              </span>
            </p>
